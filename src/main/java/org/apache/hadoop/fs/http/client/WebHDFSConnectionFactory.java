...
public class WebHDFSConnectionFactory {
	...
	public WebHDFSConnection getConnection() {
		...
		Validate.notNull(host, "Property <host> must not be null");
		Validate.notNull(port, "Property <port> must not be null");
		Validate.notNull(username, "Property <username> must not be null");
		Validate.notNull(authenticationType, "Property <authenticationType> must not be null");
